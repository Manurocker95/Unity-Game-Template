...
namespace UnityGameTemplate.Localization
{
    /// <summary>
    ...
    /// </summary>
    public class UGT_TextManager : UGT_SingletonMonobehaviour<UGT_TextManager>
    {
        #region Variables
        ...
        /// </summary>
        private Dictionary<string, Dictionary<string, UGT_TextItem>> m_texts;
        /// <summary>
        ...
        {
            StartAllListeners();
            m_texts = new Dictionary<string, Dictionary<string, UGT_TextItem>>();
            m_activelanguages = new List<SystemLanguage>();

            if (m_localizationFiles.Length == 0)
                m_localizationFiles = Resources.LoadAll<TextAsset>(UGT_PathSetup.LOCALIZATION_FILES);
            ...
            int m_currentLanguageIndex = PlayerPrefs.GetInt(UGT_GameSetup.PlayerPrefs.LAST_LANGUAGE, -1);
            ...
            else
            {
                ...
                PlayerPrefs.SetInt(UGT_GameSetup.PlayerPrefs.LAST_LANGUAGE, m_currentLanguageIndex);
            }
        }
        #endregion
        ...
        {
            Dictionary<string, UGT_TextItem> m_vTempDictionary = new Dictionary<string, UGT_TextItem>();
            ...
            foreach (XmlNode TableNode in globalTable)
            {
                ...
                if (newItemContext != "")
                {
                    ...
                    {
                        UGT_TextItem newInfoText = null;
                        //(string _key, string _text, string _audioName, bool _hasOptions, bool _showOptions)  
                        newInfoText = new UGT_TextItem(newItemContext, TableNode.ChildNodes[1].InnerText);
