...
namespace UnityGameTemplate
{
    ...
    public class pb_Debugger : EditorWindow
    {
        ...
        private void JSONToBinary()
        {
            ...
            UGT_ComplexFormatter.SaveJSONStringToDESFile(m_jsonToEncrypt.text, path, EncryptionSetup.PRIVATE_KEY);
        }
        ...
        private void DESToJSON()
        {
            ...
            string jsonString = UGT_ComplexFormatter.LoadJSONStringFromDESFile(EncryptedFilePath, EncryptionSetup.PRIVATE_KEY);
            ...
            UGT_ComplexFormatter.SaveJSONStringToJSONFile(jsonString, WhereToSave);
        }
